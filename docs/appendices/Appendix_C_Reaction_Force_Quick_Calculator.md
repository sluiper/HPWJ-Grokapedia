...
**Historical note:** The previous constant 0.745 was correct only when pressure is expressed in **MPa**. It was incorrectly paired with bar. This is the same class of √10-scale unit conversion error previously fixed in Section 16 jet velocity.
